    ...
    <div className="w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-xl overflow-hidden relative">
      ...
      <div className="relative w-full h-full flex items-center justify-center p-8">
        ...
        <div className="relative z-10">
          <div 
            className="w-40 h-40 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex flex-col items-center justify-center shadow-2xl"
            style={{
        ...
        >
          {/* Growth Metric */}
          <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 w-20 h-20 bg-white/5 border-2 border-white/20 rounded-xl flex flex-col items-center justify-center backdrop-blur-sm hover:bg-white/10 hover:border-blue-500 transition-all duration-300">
          ...
          {/* Accuracy Metric */}
          <div className="absolute -bottom-10 left-1/2 transform -translate-x-1/2 w-20 h-20 bg-white/5 border-2 border-white/20 rounded-xl flex flex-col items-center justify-center backdrop-blur-sm hover:bg-white/10 hover:border-blue-500 transition-all duration-300">
            <CheckCircle className="w-6 h-6 text-blue-400 mb-1" />
        ...
        >
          {/* Data Points Metric */}
          <div className="absolute -right-10 top-1/2 transform -translate-y-1/2 w-20 h-20 bg-white/5 border-2 border-white/20 rounded-xl flex flex-col items-center justify-center backdrop-blur-sm hover:bg-white/10 hover:border-blue-500 transition-all duration-300">
          ...
          <div className="absolute -left-10 top-1/2 transform -translate-y-1/2 w-20 h-20 bg-white/5 border-2 border-white/20 rounded-xl flex flex-col items-center justify-center backdrop-blur-sm hover:bg-white/10 hover:border-blue-500 transition-all duration-300">
        ...
        {[45, 135, 225, 315].map((rotation, i) => (
          <div
            key={i}
            className="absolute w-48 h-0.5 bg-gradient-to-r from-transparent via-blue-500 to-transparent transform-gpu"
            style={{
              top: '50%',
              left: '50%',
        ...
        >
          <div className="text-blue-400 text-xs mb-1">ROI Increase</div>
        ...
        >
          <div className="text-blue-400 text-xs mb-1">Cost Reduction</div>
