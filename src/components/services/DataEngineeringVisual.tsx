...
const DataEngineeringVisual: React.FC = () => {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden relative">
      ...
      {/* Main Container - Optimized for all screens */}
      <div className="relative w-full h-full flex flex-col p-3">
        
        {/* Data Pipeline Status Card - Compact on mobile */}
          ...
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-300 hidden md:block">Real-time processing</p>
              </div>
            </div>
            <div className="text-right">
              <div className="text-xl font-bold text-white tabular-nums">24.3K</div>
              <div className="text-xs text-gray-300">Records/sec</div>
            </div>
          </div>
        ...
        <div className="md:hidden flex-1 space-y-2 overflow-y-auto">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-2.5 border border-gray-700/50">
            ...
            <div className="grid grid-cols-3 gap-1.5">
              <div className="bg-gray-900/50 rounded p-1.5 text-center border border-gray-700/30">
                <Server className="w-4 h-4 text-gray-400 mx-auto mb-0.5" />
                <div className="text-xs text-gray-300">APIs</div>
                <div className="text-xs text-gray-500">12</div>
              </div>
              <div className="bg-gray-900/50 rounded p-1.5 text-center border border-gray-700/30">
                <Database className="w-4 h-4 text-gray-400 mx-auto mb-0.5" />
                <div className="text-xs text-gray-300">DBs</div>
                <div className="text-xs text-gray-500">8</div>
              </div>
              <div className="bg-gray-900/50 rounded p-1.5 text-center border border-gray-700/30">
                <HardDrive className="w-4 h-4 text-gray-400 mx-auto mb-0.5" />
          ...
          {/* Processing Pipeline - Simplified for mobile */}
          <div className="bg-gradient-to-br from-brand-red-900/20 to-brand-red-800/10 backdrop-blur-sm rounded-lg p-2.5 border border-brand-red-500/30">
            <h4 className="text-xs font-semibold text-brand-red-400 mb-2 text-center">ETL Pipeline</h4>
            <div className="flex justify-around items-center">
              <div className="text-center">
                <div className="bg-white/5 rounded p-1.5 border border-white/10 mb-1">
                  <GitBranch className="w-4 h-4 text-brand-red-400" />
                </div>
                <div className="text-xs text-gray-300">Extract</div>
              </div>
              <div className="text-brand-red-500">→</div>
              <div className="text-center">
                <div className="bg-white/5 rounded p-1.5 border border-white/10 mb-1">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-2.5 border border-gray-700/50">
            ...
            <div className="grid grid-cols-3 gap-1.5">
              <div className="bg-gray-900/50 rounded p-1.5 border border-gray-700/30">
                <div className="text-xs text-gray-300 text-center">Structured</div>
                <div className="text-sm font-bold text-white text-center">85%</div>
              </div>
              <div className="bg-gray-900/50 rounded p-1.5 border border-gray-700/30">
                <div className="text-xs text-gray-300 text-center">Semi</div>
                <div className="text-sm font-bold text-white text-center">12%</div>
              </div>
              <div className="bg-gray-900/50 rounded p-1.5 border border-gray-700/30">
                <div className="text-xs text-gray-300 text-center">Raw</div>
                <div className="text-sm font-bold text-white text-center">3%</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hidden md:flex flex-1 gap-3 items-center min-h-0">
          {/* Data Sources */}
          <div className="flex-1">
            <div className="bg-gray-800/50 backdrop-blur-sm rounded-lg p-3 border border-gray-700/50 h-full">
              <h4 className="text-xs font-semibold text-gray-300 mb-2 flex items-center">
                <Database className="w-3 h-3 mr-1" />
                Data Sources
              </h4>
          ...
          {/* Processing Pipeline */}
          <div className="flex-1">
            <div className="bg-gradient-to-br from-brand-red-900/20 to-brand-red-800/10 backdrop-blur-sm rounded-lg p-3 border border-brand-red-500/30 shadow-lg h-full">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded p-2 border border-white/10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-base md:text-lg font-bold text-white">1.2ms</div>
                <div className="text-xs text-gray-500">avg</div>
              </div>
              <Zap className="w-3.5 h-3.5 md:w-4 md:h-4 text-yellow-500" />
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded p-2 border border-white/10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-base md:text-lg font-bold text-white">98.7%</div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded p-2 border border-white/10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-base md:text-lg font-bold text-white">12.4TB</div>
                <div className="text-xs text-gray-500">total</div>
              </div>
              <Database className="w-3.5 h-3.5 md:w-4 md:h-4 text-brand-red-500" />
            </div>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded p-2 border border-white/10">
            <div className="flex items-center justify-between">
              <div>
                ...
                <div className="text-base md:text-lg font-bold text-white">47</div>
                <div className="text-xs text-gray-500">active</div>
              </div>
              <GitBranch className="w-3.5 h-3.5 md:w-4 md:h-4 text-blue-500" />
            </div>
          </div>
        </div>
      </div>
