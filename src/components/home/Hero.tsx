...
const Hero: React.FC = () => {
  return (
    <section className="relative">
      <div className="pt-24 pb-32 md:pt-32 md:pb-48 relative z-10">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/0 to-white pointer-events-none"></div>
