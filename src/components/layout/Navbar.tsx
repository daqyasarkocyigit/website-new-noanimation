        ...
        <div className="flex justify-between items-center">
          ...
          >
            <span className="flex items-center space-x-1 md:space-x-3">
              <span className="text-lg md:text-2xl font-black tracking-normal transition-transform duration-200 group-hover:scale-105">
                <span className="text-brand-red-600 drop-shadow-lg font-black" style={{ textShadow: '1px 1px 0 rgba(239,68,68,0.3)' }}>DAQ</span>
